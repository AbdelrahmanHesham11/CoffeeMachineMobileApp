import 'package:dhoni_coffee_machine/app/core/components/day_night_time_picker_widget.dart';
...
class HomeMachineScreen extends GetView<HomeMachineController> {
  const HomeMachineScreen({super.key});
  ...
  void _getResponse(String message) {
    ...
    switch (message.toLowerCase()) {
      case 'hi':
        ...
        break;
      case 'how are you':
        response = 'I am very good thank you!';
        break;
